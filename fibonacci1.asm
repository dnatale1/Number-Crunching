...
;
; nasm -o fibonacci1.o -f elf fibonacci1.asm
; ld -s -o fibonacci1 fibonacci1.o
; ./fibonacci1
;
;****************************************************************************
; Alterable Constant
...
; NOTES: 1. David Natale made a few modifications to this program on 06-21-07.
;           Only the last term is printed instead of the entire sequence. 
;           Eventhough 'Fibonacci(1)' is displayed, the result is correct.
;           On my computer powered with a 32-bit Pentium 4 at 2.8 GHz,
;           the 150000th Fibonacci number is calculated and printed in 169 sec.
;           Interestingly, my Fibonacci program coded in Python can achieve
;           this same result in 5 seconds.
;
;         2. This program works for a 32-bit computer, not a 64-bit (yet?)
